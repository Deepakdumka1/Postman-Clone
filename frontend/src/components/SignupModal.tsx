      ...
      <div className="password-strength">
        <div className="strength-bars">
          {[1, 2, 3, 4, 5].map((level) => (
            <div 
              key={level}
              className={`strength-bar ${passwordStrength.score >= level ? 'filled' : ''}`}
        ...
        <div className="futuristic-modal success-modal">
          <div className="success-icon">
            <svg width="64" height="64" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M22 11.0857V12.0057C21.9988 14.1621 21.3005 16.2604 20.0093 17.9875C18.7182 19.7147 16.9033 20.9782 14.8354 21.5896C12.7674 22.201 10.5573 22.1276 8.53447 21.3803C6.51168 20.633 4.78465 19.2518 3.61096 17.4428C2.43727 15.6338 1.87979 13.4938 2.02168 11.342C2.16356 9.19029 2.99721 7.14205 4.39828 5.5028C5.79935 3.86354 7.69279 2.72111 9.79619 2.24587C11.8996 1.77063 14.1003 1.98806 16.07 2.86572" stroke="#00C853" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
              <path d="M22 4L12 14.01L9 11.01" stroke="#00C853" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
          </div>
          <h2>Account Created!</h2>
          <p>Your account has been created successfully. Redirecting you to the main application...</p>
  ...
  return (
    <div className="futuristic-modal-overlay" onClick={handleModalClick}>
      <div className="futuristic-modal signup-modal">
        <button className="futuristic-modal-close" onClick={onClose} aria-label="Close signup modal">
        ...
        <form onSubmit={handleSubmit} noValidate>
          {errors.form && (
            <div className="form-error-message">
              <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M8 4V8M8 12H8.01M15 8C15 11.866 11.866 15 8 15C4.13401 15 1 11.866 1 8C1 4.13401 4.13401 1 8 1C11.866 1 15 4.13401 15 8Z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
              </svg>
              {errors.form}
            </div>
          )}
          
          <div className={`futuristic-form-group ${formSubmitted && errors.name ? 'has-error' : ''}`}>
          ...
          <div className={`futuristic-form-group ${formSubmitted && errors.email ? 'has-error' : ''}`}>
          ...
          <div className={`futuristic-form-group ${formSubmitted && errors.password ? 'has-error' : ''}`}>
            <label htmlFor="password">Password</label>
            <div className="custom-input-container2">
              <div className="icon-container">
                <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M14.25 8.25H3.75C2.92157 8.25 2.25 8.92157 2.25 9.75V15C2.25 15.8284 2.92157 16.5 3.75 16.5H14.25C15.0784 16.5 15.75 15.8284 15.75 15V9.75C15.75 8.92157 15.0784 8.25 14.25 8.25Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                  <path d="M5.25 8.25V5.25C5.25 4.05653 5.72411 2.91193 6.56802 2.06802C7.41193 1.22411 8.55653 0.75 9.75 0.75C10.9435 0.75 12.0881 1.22411 12.932 2.06802C13.7759 2.91193 14.25 4.05653 14.25 5.25V8.25" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
              </div>
              <input
              ...
              >
                {showPassword ? (
                  <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M2.25 9C2.25 9 4.5 3.75 9 3.75C13.5 3.75 15.75 9 15.75 9C15.75 9 13.5 14.25 9 14.25C4.5 14.25 2.25 9 2.25 9Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                    ...
                    <path d="M3 3L15 15" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                  </svg>
                ) : (
                  <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M2.25 9C2.25 9 4.5 3.75 9 3.75C13.5 3.75 15.75 9 15.75 9C15.75 9 13.5 14.25 9 14.25C4.5 14.25 2.25 9 2.25 9Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
            ...
            <div className="password-requirements">
              <div className="requirement">
                <span className={formData.password.length >= 8 ? 'requirement-met' : ''}>
                  {formData.password.length >= 8 ? '✓' : '•'}
                </span>
                <span>At least 8 characters</span>
              </div>
              <div className="requirement">
                <span className={/[A-Z]/.test(formData.password) ? 'requirement-met' : ''}>
                  {/[A-Z]/.test(formData.password) ? '✓' : '•'}
                </span>
                <span>One uppercase letter</span>
              </div>
              <div className="requirement">
                <span className={/[0-9]/.test(formData.password) ? 'requirement-met' : ''}>
                  {/[0-9]/.test(formData.password) ? '✓' : '•'}
                </span>
                <span>One number</span>
              </div>
              <div className="requirement">
                <span className={/[!@#$%^&*(),.?":{}|<>]/.test(formData.password) ? 'requirement-met' : ''}>
          ...
          <div className={`futuristic-form-group ${formSubmitted && errors.confirmPassword ? 'has-error' : ''}`}>
            <label htmlFor="confirmPassword">Confirm Password</label>
            <div className="custom-input-container3">
              <div className="icon-container">
                <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M14.25 8.25H3.75C2.92157 8.25 2.25 8.92157 2.25 9.75V15C2.25 15.8284 2.92157 16.5 3.75 16.5H14.25C15.0784 16.5 15.75 15.8284 15.75 15V9.75C15.75 8.92157 15.0784 8.25 14.25 8.25Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                  <path d="M12.75 8.25V6C12.7517 4.7889 12.3097 3.62482 11.5 2.7375C10.6902 1.85017 9.58499 1.3082 8.37495 1.25636C7.16492 1.20453 5.98043 1.64646 5.09323 2.48408C4.20602 3.32171 3.68429 4.48207 3.65625 5.7" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
              </div>
              <input
          ...
          <div className={`futuristic-form-group terms-group ${formSubmitted && errors.terms ? 'has-error' : ''}`}>
